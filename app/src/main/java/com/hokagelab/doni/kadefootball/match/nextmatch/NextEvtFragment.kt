...
class NextEvtFragment : Fragment(), AnkoComponent<Context>, NextEvtView {
    ...
    private lateinit var presenter: NextEvtPresenter
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        presenter = NextEvtPresenter(this, ApiRepository())
        ...
        when (savedInstanceState != null) {
            true -> {
                ...
                matchList = savedInstanceState.getParcelableArrayList<MatchEvent>("NEXT_MATCH")
                showFixtureList(matchList)
            }
            false -> presenter.getNextFixtureList(leagueIDs[positionItem])
        }

        swipeRefresh.setOnRefreshListener {
            presenter.getNextFixtureList(leagueIDs[positionItem])
                        ...
                        onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
                            ...
                            override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                                if (positionItem != position) {
                                    ...
                                    presenter.getNextFixtureList(leagueIDs[position])
                                }
                            }
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        outState.putParcelableArrayList("NEXT_MATCH", matchList)
